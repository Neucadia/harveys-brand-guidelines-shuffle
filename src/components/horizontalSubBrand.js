...
import { ReactComponent as CommoditiesBlackSVG } from "../assets/logos/horizontal-commodities-black.svg";
import { ReactComponent as SeedBlackSVG } from "../assets/logos/horizontal-seed-black.svg";
import { ReactComponent as FeedBlackSVG } from "../assets/logos/horizontal-feed-black.svg";
import { ReactComponent as GardenCenterBlackSVG } from "../assets/logos/horizontal-garden-center-black.svg";
import { ReactComponent as RetailBlackSVG } from "../assets/logos/horizontal-retail-black.svg";
import { ReactComponent as CommoditiesGreenSVG } from "../assets/logos/horizontal-commodities-green.svg";
import { ReactComponent as SeedGreenSVG } from "../assets/logos/horizontal-seed-green.svg";
import { ReactComponent as FeedGreenSVG } from "../assets/logos/horizontal-feed-green.svg";
import { ReactComponent as GardenCenterGreenSVG } from "../assets/logos/horizontal-garden-center-green.svg";
import { ReactComponent as RetailGreenSVG } from "../assets/logos/horizontal-retail-green.svg";
import { ReactComponent as CommoditiesOrangeSVG } from "../assets/logos/horizontal-commodities-orange.svg";
import { ReactComponent as SeedOrangeSVG } from "../assets/logos/horizontal-seed-orange.svg";
import { ReactComponent as FeedOrangeSVG } from "../assets/logos/horizontal-feed-orange.svg";
import { ReactComponent as GardenCenterOrangeSVG } from "../assets/logos/horizontal-garden-center-orange.svg";
import { ReactComponent as RetailOrangeSVG } from "../assets/logos/horizontal-retail-orange.svg";
import { ReactComponent as CommoditiesWheatSVG } from "../assets/logos/horizontal-commodities-wheat.svg";
import { ReactComponent as SeedWheatSVG } from "../assets/logos/horizontal-seed-wheat.svg";
import { ReactComponent as FeedWheatSVG } from "../assets/logos/horizontal-feed-wheat.svg";
import { ReactComponent as GardenCenterWheatSVG } from "../assets/logos/horizontal-garden-center-wheat.svg";
import { ReactComponent as RetailWheatSVG } from "../assets/logos/horizontal-retail-wheat.svg";
import { ReactComponent as CommoditiesWhiteSVG } from "../assets/logos/horizontal-commodities-white.svg";
import { ReactComponent as SeedWhiteSVG } from "../assets/logos/horizontal-seed-white.svg";
import { ReactComponent as FeedWhiteSVG } from "../assets/logos/horizontal-feed-white.svg";
import { ReactComponent as GardenCenterWhiteSVG } from "../assets/logos/horizontal-garden-center-white.svg";
import { ReactComponent as RetailWhiteSVG } from "../assets/logos/horizontal-retail-white.svg";
    ...
    <div className="w-full shadow-lg bg-white flex flex-col mb-10">
      <div className="py-20 px-8 flex-col justify-center flex-grow flex">
        ...
        <p className="text-gray-500 max-w-xs mx-auto text-center mb-5">
          This will be gradually integrated with the primary sub-brand logo.
          They will be used together in various applications to build brand
          recognition from the start and reinforce the relationship with our
          brand.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            className="px-6 py-3 block text-center w-full sm:w-auto bg-yellow-500 text-sm font-semibold hover:bg-yellow-400 focus:ring focus:ring-yellow-200 transition duration-200"
            href="/logos/horizontal-subbrand-PNGs.zip"
          >
            Download PNG
          </a>
          <a
            ...
            href="/logos/horizontal-subbrand-SVGs.zip"
          >
            Download SVG
          </a>
        </div>
...
export default HorizontalSubBrand;
