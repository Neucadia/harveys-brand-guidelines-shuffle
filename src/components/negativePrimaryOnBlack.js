    ...
    <div className="w-full shadow-lg flex flex-col mb-10 bg-black">
      <div className="py-20 px-8 flex-col justify-center flex-grow flex">
        ...
        <p className="max-w-xs mx-auto mb-5 text-white text-center">
          ...
          stand out clearly against darker tones.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <a
            ...
            href="/logos/negative-primary-PNGs.zip"
          >
            Download PNG
          </a>
          <a
            ...
            href="/logos/negative-primary-SVGs.zip"
          >
            Download SVG
          </a>
        </div>
...
export default NegativePrimaryOnBlack;
