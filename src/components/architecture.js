  ...
  return (
    <section id="architecture" className="py-20 bg-yellow-500 ">
      <div className="container mx-auto px-4">
        ...
        <h1 className="font-heading text-4xl lg:text-5xl text-center mx-auto mb-16 text-black font-bold max-w-lg lg:max-w-3xl uppercase tracking-widest">
          BRAND HIERARCHY
        </h1>
        <div className="flex flex-wrap -m-4">
          <div className="w-full p-4">
            <div className="bg-white p-12 flex flex-col items-center">
              ...
              <p className="text-gray-600 max-w-md">
                Harvey's is Carson City's landmark agricultural brand, offering
                premium seed, custom feed solutions, flexible commodities
                logistics, seasonal garden essentials, and quality retail
                products—all backed by unmatched service and deep-rooted local
                expertise.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 p-4">
            <div className="bg-white p-12 flex flex-col items-center">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Shipping to over 200 large dairies across 7 states with annual
                deliveries topping 1 million tons, Harvey's Commodities is a
                behemoth of agile logistics and dependability.
              </p>
              <p className="gray-accent text-gray-500 font-bold mb-4 font-heading uppercase tracking-widest">
                1-sentence description
              </p>
              <p className="text-gray-600 max-w-md mb-8">
                Harvey's Commodities delivers flexible, reliable feed solutions
                and expert contracting services, simplifying nutrition
                management for dairy operations across the Midwest.
              </p>
              <p className="gray-accent text-gray-500 font-bold mb-4 font-heading uppercase tracking-widest">
                1-sentence CTA
              </p>
              <p className="text-gray-600 max-w-md">
                Simplify your dairy nutrition—partner with Harvey’s Commodities
                for flexible feed solutions, expert service, and logistics you
                can count on.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 p-4">
            <div className="bg-white p-12 flex flex-col items-center">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                ...
                iteration of Harvey's Agricultural Solutions; except, Harvey's
                Seed is a much leaner, more focused endeavor. Harvey's Seed is
                the nimble predecessor with a focus on speciality seeds,
                non-GMO, cover crops, high management, and traditional row.
              </p>
              <p className="gray-accent text-gray-500 font-bold mb-4 font-heading uppercase tracking-widest">
                1-sentence description
              </p>
              ...
              <p className="text-gray-600 max-w-md">
                At Harvey’s Seed, we’re proud to partner with some of the finest
                growers in the world, combining premium seed with exceptional
                service to keep your farm thriving no matter the circumstance.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 p-4">
            <div className="bg-white p-12 flex flex-col items-center">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Since 1866, the Carson City mill has stood next to Fish Creek
                welcoming residents from near and far with its iconic pitched
                roof. The vitality of the mill is a testament to the strength
                and resilience of small towns and small business. What started
                as a saw mill transitioned to a grist mill and finally the high
                tech livestock feed mixer it is today, mixing over 30,000 tons
                annually.
              </p>
              <p className="gray-accent text-gray-500 font-bold mb-4 font-heading uppercase tracking-widest">
                1-sentence description
              ...
              <p className="text-gray-600 max-w-md">
                ...
                feeds—including specializing in custom-blended solutions—backed
                by expert nutritional support and our partnership with ADM.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 p-4">
            <div className="bg-white p-12 flex flex-col items-center">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                ...
                annuals, perennials, trees, shrubs, and gardening essentials to
                bring landscape to life.
              </p>
              <p className="gray-accent text-gray-500 font-bold mb-4 font-heading uppercase tracking-widest">
                1-SENTENCE CTA
              </p>
              <p className="text-gray-600 max-w-md">
                Located right next door to Harvey’s, our seasonal Garden Center
                is your go-to spot for beautiful annuals, perennials, trees,
                shrubs, and everything else you need to make your yard shine.
              </p>
            </div>
          </div>
          <div className="w-full lg:w-1/2 p-4">
            <div className="bg-white p-12 flex flex-col items-center">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                The original outpost for Montcalm County when a gristmill was
                built along Fish Creek in 1870, we're not sure when the general
                store first opened, but we try to bring a little of that
                frontier charm to Harvey's.
              </p>
              <p className="gray-accent text-gray-500 font-bold mb-4 font-heading uppercase tracking-widest">
                1-sentence description
              </p>
              <p className="text-gray-600 max-w-md">
                Harvey's is Mid-Michigan's premier destination for exceptional
                feed, seed, apparel, and footwear, delivering unmatched quality,
                expert guidance, and a heritage of trusted service since 1946.
              </p>
            </div>
          </div>
        </div>
